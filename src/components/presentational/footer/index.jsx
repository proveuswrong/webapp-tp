...
export default function Index() {
  return (
    <footer className={styles.footer}>
      <span className={`ellipsis ${styles.containerText}`}>Work-in-progress. Expect missing or broken functionality and bugs.</span>
      ...
      <span className={styles.social}>
        ...
        <a href='https://proveuswrong.io' target='_blank' rel='noopener noreferrer'
           className={styles.copyright}>Copyright {new Date().getFullYear()} Prove Us Wrong</a>
